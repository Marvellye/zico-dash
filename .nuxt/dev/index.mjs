...
import { digest } from 'file:///home/project/node_modules/nitropack/node_modules/ohash/dist/index.mjs';
...
import { basename } from 'file:///home/project/node_modules/@nuxt/icon/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///home/project/node_modules/@iconify/utils/lib/index.mjs';
import { hash as hash$1 } from 'file:///home/project/node_modules/ohash/dist/index.mjs';
import { collections } from 'file:///home/project/.nuxt/nuxt-icon-server-bundle.mjs';
...
`,
    ...
    return getRequestHeader(event, "accept")?.includes("text/html") ? send(
      event,
...
const _RICUM2mDMwWbJI_f87EyS9QSvhYn2rq0mE97kti5Q = (nitroApp) => {
...
const plugins = [
  _RICUM2mDMwWbJI_f87EyS9QSvhYn2rq0mE97kti5Q,
...
const _oEmfeo = defineCachedEventHandler(async (event) => {
...
const _lazy_a7_jZP = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_a7_jZP, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _oEmfeo, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_a7_jZP, lazy: true, middleware: false, method: undefined }
];
